...
ADDRESS = "TPjJDf6nMjrmRxfW7wEQBM4tvVQag8RDCq".lower()
BASE_URL = f"https://tron-mainnet.g.alchemy.com/v2/{API_KEY}"
...
async def main():
    ...
    with open("unique_senders_alchemy_tron.txt", "w") as f:
